...
public class SSearch extends JDialog implements ActionListener, ItemListener,FocusListener{
	...
	public SSearch(JFrame a,String title,Boolean bm){
		...
		for(int i=1;i<12;i++){
			int j=430+(40*i);
			lsid[i].setBounds(100,j,100,40);lnm[i].setBounds(200,j,450,40);lcon[i].setBounds(650,j,200,40);
		}
		setSize(850,1000);
