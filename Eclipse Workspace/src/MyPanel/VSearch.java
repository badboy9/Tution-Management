...
public class VSearch extends JDialog implements ActionListener, ItemListener,FocusListener{
	...
	public VSearch(JFrame a,String title,Boolean bm){
		...
		ccs1=new Checkbox("IX");ccs1.addItemListener(this);//ccs1.setEditable(false);
		ccs1.setCheckboxGroup(cgcls);ccs1.setFont(fobj2);
		ccs2=new Checkbox("X");ccs2.addItemListener(this);//ccs2.setEditable(false);
		ccs2.setCheckboxGroup(cgcls);ccs2.setFont(fobj2);

		scl=new Choice();scl.addItemListener(this);//scl.setEditable(false);
		scl.setFont(fobj2);
		...
		ls=new JLabel("SEARCH");ls.setFont(fobj1);
		...
		bhome=new JButton("Home");bhome.addActionListener(this);bhome.setFont(new Font("Roman",Font.PLAIN,20));
		bsrch=new JButton("Search");bsrch.addActionListener(this);bsrch.setFont(new Font("Roman",Font.PLAIN,20));
		bsel=new JButton("Select");bsel.addActionListener(this);bsel.setFont(new Font("Roman",Font.PLAIN,20));
	...
	public void actionPerformed(ActionEvent e){
		...
		if(b==bsel){
			...
			DForm mod=new DForm(this,"Display",true,k);
			flg2=0;
		}
		if(b==bhome){
			parent.setVisible(true);
